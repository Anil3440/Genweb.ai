  ...
  try {
    ...
    if (user.credits < 50) {
      return res
        ...
        .json({
          message:
            "you don't have enough credits, kindly purchase some to continue building websites.",
        });
    }
    ...
    if (!parsed.code) {
      ...
      return res
        .status(500)
        .json({ message: "ai returned invalid response" });
    }
    ...
    return res
      .status(500)
      .json({ message: `error generating website ${error}` });
  }
};
  ...
  try {
    ...
    if (user.credits < 25) {
      return res
        ...
        .json({
          message:
            "you don't have enough credits, kindly purchase some to continue editing website.",
        });
    }

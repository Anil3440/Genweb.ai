...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen bg-black text-white overflow-hidden">
          ...
          <div className="flex items-center gap-5">
            ...
            {!userData ? (
              <button
                ...
                className="px-4 py-2 rounded-lg border borde-white/20 hover:bg-white/10 text-sm cursor-pointer"
              >
                Get Started
              </button>
            ) : (
      ...
      {/* Hero Section */}
      {/* NOTE: Keep <section> as a plain element so it holds its layout space.
             Only animate the inner wrapper — avoids the scroll-on-reload bug
             caused by the section itself starting offset in the document flow. */}
      <section className="pt-30 pb-20 px-6 text-center">
        <motion.div
          initial="hidden"
          animate="visible"
          variants={{
        ...
        >
          ...
          >
            Give your website ideas a shape with <br />
          ...
          >
            Describe your idea and let ai generate a mordern, responsive,
          ...
          <motion.button
            ...
            className="mt-10 px-10 py-4 rounded-xl bg-white text-black text-xl font-bold cursor-pointer"
            onClick={
